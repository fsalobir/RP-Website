-- Appliquer les stat_delta issus de global_growth_effects à tous les pays.
-- Remplace run_daily_country_update pour inclure stat_effects_global (pour les bases ayant déjà appliqué 044).
...
COMMENT ON FUNCTION public.run_daily_country_update() IS
  'Cron quotidien : snapshot country_history, évolution score mobilisation, mise à jour pays (global_growth_effects + country_effects + mobilisation + stat_delta global + bonus budget), décrément country_effects.';
