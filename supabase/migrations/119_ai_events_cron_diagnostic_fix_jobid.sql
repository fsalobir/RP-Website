-- Fix: cron.job_run_details a une colonne jobid, pas jobname. Filtrer par jobid depuis cron.job.
...
COMMENT ON FUNCTION public.get_ai_events_cron_diagnostic() IS 'Diagnostic pg_cron pour la page admin Event IA : extension, job ai-events-generation, dernières exécutions (job_run_details filtré par jobid), last_run.';
