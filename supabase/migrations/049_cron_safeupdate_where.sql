-- pg-safeupdate exige un WHERE sur les UPDATE. L'UPDATE sur country_mobilisation
-- met à jour toutes les lignes (score vers target_score) ; on ajoute WHERE TRUE.
