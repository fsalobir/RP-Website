...
VALUES (
  ...
  '{
    ...
    "recrutement": { "min_points_per_tick": 1, "max_points_per_tick": 10 },
    "stock": { "min_points_per_tick": 1, "max_points_per_tick": 10 },
    "procuration": { "base_points_per_tick": 0, "points_per_pct_budget": 0.5 }
  }'::jsonb,
  'Config État Major : points par tick (Design = industrie, Recrutement = militarisme, Stock = science, Procuration = budget).'
),
(
